...
for symbol in unique_symbols:
    ...
    if len(df_filtered) >= 2:  # Mude para 1 se você deseja pelo menos uma amostra
        ...
        # Salvar o gráfico em um arquivo com o nome do símbolo
        plt.plot(df_filtered['Cum_Ret'], color='red', label='Cumulative Return')
        plt.plot(df_filtered['Cum_Strategy'], color='blue', label='Cumulative Strategy Return')
        plt.legend()
