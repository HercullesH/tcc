...
mpf.plot(candlestick_df, type='candle', style='charles', volume=True, ylabel='Preço', title=f'Gráfico de Candlestick - {symbol} (Original)', savefig=f'candlestick_original_{symbol}.png')
mpf.plot(candlestick_df_previsao, type='candle', style='charles', volume=True, ylabel='Preço', title=f'Gráfico de Candlestick - {symbol} (Previsto)', savefig=f'candlestick_previsto_{symbol}.png')
